    ...
    <section className="bg-gray-100 py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="w-1/2 bg-gray-300 h-40 flex items-center justify-center">
        ...
        <div className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-12 mt-12 text-center">
